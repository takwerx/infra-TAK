...
function initTakDeployModeUI(rootEl){
    ...
    var extHtml=[
      ...
      '<li>Click <strong>Save</strong> in the Azure Portal, then come back here and click <strong>3. Provision Database</strong>.</li>',
      '</ol>',
      '<p style="margin:0;font-size:11px;color:var(--text-dim)">Provision Database will automatically handle the remaining Azure-specific grants. Test Connection will verify extensions are live before allowing deploy.</p>',
      '</div>',
      '</details>',
