...
### v0.9.32-alpha — 2026-05-19 — Two-bug hotfix on v0.9.31: dashboard JS parse-abort (every onclick broken on Console page) + kernel-patch "Reboot now" banner re-fires forever after every reboot
