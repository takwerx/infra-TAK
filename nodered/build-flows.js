...
"  hp.push('g' + _PT_CAP + 'b' + Math.min(4000, _PT_CAP * 8) + 'm' + Number((cfg.mapping && cfg.mapping.minRingVerts) || 0));",
...
"  var _hash = djb2(hp.join('|'));",
  ...
  "      var _budget = Math.min(4000, _PT_CAP * 8);",
  "      _ringCaps = [];",
  ...
  "      _parts.push({ uid: _isMultiPoly ? uid+'-r'+_ri2 : uid, _hash: _isMultiPoly ? djb2(_hash+'|r'+_ri2+'|'+_rgk) : _hash, lat: _rsy/_rr2.length, lon: _rsx/_rr2.length, verts: _simp(_rr2, true, _ringCaps ? _ringCaps[_ri2] : _PT_CAP) });",
  "    }",
