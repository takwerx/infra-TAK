...
"  var _hash = djb2(hp.join('|'));",
  ...
  "  var _ctrLbl = (cls.centerLabel != null) ? cls.centerLabel : (cfg.style.centerLabel != null ? cfg.style.centerLabel : true);",
  "  var detail = {};",
  "  if (kind === 'point' || _ctrLbl !== false) detail.contact = [{ _attributes: { callsign: callsign } }];",
